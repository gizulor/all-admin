...
class alladmin_theme extends \Textpattern\Admin\Theme
{
    function html_head()
    {
        $out[] = '<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">';
        $out[] = '<link rel="stylesheet" href="'.$this->url.'assets/css/alladmin.css">';
        ...
        $out[] = '<script defer src="'.$this->url.'assets/js/alladmin-min.js"></script>'.n;
